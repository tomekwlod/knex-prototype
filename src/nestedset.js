            ...
            return async function (...args) {
                ...
                if (normalize !== false) {
                    ...
                    if (typeof this[normalize] !== 'function') {
                        ...
                        throw new Error(`knex-prototype, nextedset.js, treeCheckIntegrity(): normalize function '${normalize}' is defined but there is no such method in '${this.__table}' manager`);
                    }
