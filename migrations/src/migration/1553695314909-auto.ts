...
export class auto1553695314909 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `tree` CHANGE `updated` `updated` datetime(0) NULL ON UPDATE CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `tree` CHANGE `created` `created` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP");
